...
// Пример тестовых данных (потом можно заменить на данные из Steam API)
const gamesData = [
  {
    name: "Elden Ring",
    genre: "РПГ",
...
// Добавляем все тестовые игры на страницу
